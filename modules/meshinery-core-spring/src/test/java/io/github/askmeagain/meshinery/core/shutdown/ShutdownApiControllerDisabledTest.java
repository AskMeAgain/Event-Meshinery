...
@TestPropertySource(properties = "meshinery.core.shutdown-api=false")
class ShutdownApiControllerDisabledTest {
  ...
  void testShutdown() throws Exception {
    ...
    //Assert ---------------------------------------------------------------------------------
    Mockito.verify(roundRobinScheduler, never()).gracefulShutdown();
  }
